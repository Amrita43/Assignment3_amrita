...
{
    public class A1MedicationController : Controller
    {
        private readonly PatientsContext _context;

        public A1MedicationController(PatientsContext context)
        {
            _context = context;
        }
